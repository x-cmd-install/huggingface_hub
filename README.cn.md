...
![huggingface_hub](https://repo.x-cmd.io/huggingface_hub.svg)
...
- **最新版本**: `v1.30.0` (2026-09-03)
- **最近提交**: 2026-09-09
- **发布时间**: 2026-09-03T09:42:41Z

## 流行度

- **Star**: 3,880 · **Fork**: 1,194 · **开放 issue**: 1,659 · **贡献者**: 396

## 累计统计

- **发布数**: 190 · **已合并 PR**: 2501 · **开放 PR**: 54 · **已关闭 issue**: 1539 · **开放 issue**: 120 · **提交数**: 2719
...
合计: **101,428** 行代码（覆盖前 5 种语言、共 **310** 个文件）。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T04:24:00Z._
